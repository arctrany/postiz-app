import { AgentToolInterface } from '@xpoz/nestjs-libraries/chat/agent.tool.interface';
import { createTool } from '@mastra/core/tools';
import { z } from 'zod';
import { Injectable } from '@nestjs/common';
import { socialIntegrationList } from '@xpoz/nestjs-libraries/integrations/integration.manager';
...
import { AllProvidersSettings } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/all.providers.settings';
import { validate } from 'class-validator';
import { Integration } from '@prisma/client';
import { checkAuth } from '@xpoz/nestjs-libraries/chat/auth.context';
