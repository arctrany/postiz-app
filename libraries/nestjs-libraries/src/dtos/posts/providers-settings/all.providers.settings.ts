...
import { PinterestSettingsDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/pinterest.dto';
import { YoutubeSettingsDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/youtube.settings.dto';
import { TikTokDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/tiktok.dto';
import { XDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/x.dto';
import { LemmySettingsDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/lemmy.dto';
import { DribbbleDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/dribbble.dto';
import { DiscordDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/discord.dto';
import { SlackDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/slack.dto';
import { KickDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/kick.dto';
import { TwitchDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/twitch.dto';
import { InstagramDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/instagram.dto';
...
import { DevToSettingsDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/dev.to.settings.dto';
import { HashnodeSettingsDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/hashnode.settings.dto';
import { WordpressDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/wordpress.dto';
import { ListmonkDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/listmonk.dto';
import { GmbSettingsDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/gmb.settings.dto';
import { FarcasterDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/farcaster.dto';
...
import { SkoolDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/skool.dto';
import { WhopDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/whop.dto';
import { MeweDto } from '@xpoz/nestjs-libraries/dtos/posts/providers-settings/mewe.dto';
