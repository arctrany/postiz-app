...
import { AuthService as AuthChecker } from '@xpoz/helpers/auth/auth.service';
...
import { NewsletterService } from '@xpoz/nestjs-libraries/newsletter/newsletter.service';
