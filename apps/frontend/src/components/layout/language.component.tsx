...
const getCountryCodeForFlag = (languageCode: string) => {
  ...
  if (languageCode === 'th') return 'TH';  // Thailand
  if (languageCode === 'id') return 'ID';  // Indonesia
  if (languageCode === 'ms') return 'MY';  // Malaysia
  if (languageCode === 'tl') return 'PH';  // Philippines
