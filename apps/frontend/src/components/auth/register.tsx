...
import { CreateOrgUserDto } from '@xpoz/nestjs-libraries/dtos/auth/create.org.user.dto';
...
import { WalletUiProvider } from '@xpoz/frontend/components/auth/providers/placeholder/wallet.ui.provider';
import { useT } from '@xpoz/react/translation/get.transation.service.client';
import useCookie from 'react-use-cookie';
const WalletProvider = dynamic(
  () => import('@xpoz/frontend/components/auth/providers/wallet.provider'),
  {
    ssr: false,
