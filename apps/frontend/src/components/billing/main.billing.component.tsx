...
import { Slider } from '@xpoz/react/form/slider';
...
import { FAQComponent } from '@xpoz/frontend/components/billing/faq.component';
...
import { Textarea } from '@xpoz/react/form/textarea';
import { useFireEvents } from '@xpoz/helpers/utils/use.fire.events';
import { useUtmUrl } from '@xpoz/helpers/utils/utm.saver';
import { useTrack } from '@xpoz/react/helpers/use.track';
import { TrackEnum } from '@xpoz/nestjs-libraries/user/track.enum';
import { PurchaseCrypto } from '@xpoz/frontend/components/billing/purchase.crypto';
import { useT } from '@xpoz/react/translation/get.transation.service.client';
import { FinishTrial } from '@xpoz/frontend/components/billing/finish.trial';
