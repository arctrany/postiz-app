...
# Copilot Coding Agent Instructions for XPoz
...
- SDK (`apps/sdk`) provides programmatic access to XPoz features.
...
## Documentation
- Main docs: https://docs.xpoz.com/
- Developer guide: https://docs.xpoz.com/developer-guide
- Public API: https://docs.xpoz.com/public-api
